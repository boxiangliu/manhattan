...
Introducing `manhattan`, a `ggplot2` based package for making Manhattan plots. It takes in a `data.frame` and returns a standard `ggplot` object, upon which the user can add other `geom`.
...
## Questions and Bug
If you have any question or want to report a bug, please open a github issue at 